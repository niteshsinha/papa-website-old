...
<?php
	...
	//// IF NOT ACTIVE, DIE AND TELL ////
		...
		die('<html><head><title>minishowcase | Private Directory</title><style>p{padding:10px;color:#fff;background:#f60;}a{padding:10px;color:#fc0;}a:hover{color:#fff;}</style></head><body><p><a href="javascript:history.go(-1);">&#171; back</a> minishowcase says: <b>this directory is priva